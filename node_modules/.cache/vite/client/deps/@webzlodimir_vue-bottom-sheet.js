...
// node_modules/@webzlodimir/vue-bottom-sheet/dist/vue-bottom-sheet.es.js
var import_hammerjs = __toESM(require_hammer());
var U = (n) => (pushScopeId("data-v-f0c780e0"), n = n(), popScopeId(), n);
var X = ["aria-hidden"];
var Z = U(() => createBaseVNode("div", { class: "bottom-sheet__draggable-thumb" }, null, -1));
var ee = [
  Z
];
var te = defineComponent({
  ...
  setup(n, { expose: p, emit: i }) {
    ...
    useCssVars((e) => ({
      42568111: D.value,
      "0327c788": t.overlayColor,
      "7008c7cb": B.value,
      "09c72560": T.value,
      "734f206c": $.value,
      "152d8c25": V.value
    }));
    const c = ref(false), u = ref(0), l = ref(100), f = ref(false), b = ref(0), y = ref(null), S = ref(null), d = ref(null), w = ref(null), k = ref(null), C = ref(null), E = (e) => document.activeElement === e;
    ...
    ]), D = computed(() => `${t.transitionDuration}s`), T = computed(() => u.value && u.value > 0 ? `${u.value + 1}px` : "auto"), V = computed(() => t.maxHeight ? `${t.maxHeight}px` : "inherit"), B = computed(() => `${l.value}%`), $ = computed(() => `${t.maxWidth}px`), Y = async () => {
      await nextTick(), u.value = S.value.offsetHeight + d.value.clientHeight + w.value.offsetHeight;
    }, H = (e, o) => {
      if (t.canSwipe) {
        f.value = true;
        const h = (L) => {
        ...
        e.deltaY > 0 && (o === "main" && e.type === "panup" && (l.value = g(e.deltaY), e.cancelable && d.value.addEventListener("touchmove", h)), o === "main" && e.type === "pandown" && b.value === 0 && (l.value = g(e.deltaY)), o === "area" && (l.value = g(e.deltaY)), e.type === "panup" && i("dragging-up"), e.type === "pandown" && i("dragging-down")), e.isFinal && (d.value.removeEventListener("touchmove", h), o === "main" && (b.value = d.value.scrollTop), f.value = false, l.value >= 10 ? v() : l.value = 0);
      }
    };
    nextTick(() => {
      Y();
      const e = new import_hammerjs.default(C.value, {
        inputClass: import_hammerjs.default.TouchMouseInput,
        recognizers: [[import_hammerjs.default.Pan, { direction: import_hammerjs.default.DIRECTION_VERTICAL }]]
      }), o = new import_hammerjs.default(d.value, {
        inputClass: import_hammerjs.default.TouchMouseInput,
        recognizers: [[import_hammerjs.default.Pan, { direction: import_hammerjs.default.DIRECTION_VERTICAL }]]
      });
    ...
    const A = () => {
      l.value = 0, document.documentElement.style.overflowY = "hidden", document.documentElement.style.overscrollBehavior = "none", c.value = true, i("opened");
    }, v = async () => {
      c.value = false, l.value = 100, setTimeout(() => {
    ...
    return p({ open: A, close: v }), (e, o) => (openBlock(), createBlock(Teleport, { to: "body" }, [
      createBaseVNode("div", {
        class: "bottom-sheet",
        ref_key: "bottomSheet",
        ref: y,
...
var le = oe(te, [["__scopeId", "data-v-f0c780e0"]]);
export {
  le as default
};
...
*/
//# sourceMappingURL=@webzlodimir_vue-bottom-sheet.js.map
