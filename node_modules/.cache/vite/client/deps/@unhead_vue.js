...
function flattenMetaObjects(input, prefix = "") {
  ...
  for (const [key, value] of Object.entries(input)) {
    ...
    const unpacker = (_a = MetaPackingSchema[key]) == null ? void 0 : _a.unpack;
    if (unpacker) {
...
function unpackMeta(input) {
  ...
  extras.push(
    ...flattenMetaObjects(input).sort((a, b) => {
      var _a, _b, _c;
      if ((_a = a.property) == null ? void 0 : _a.startsWith("og:image")) {
        if ((_b = b.property) == null ? void 0 : _b.startsWith("og:image"))
          return 0;
        else
          return -1;
      }
      if ((_c = b.property) == null ? void 0 : _c.startsWith("og:image"))
        return 1;
      return 0;
    })
  );
...
// node_modules/@unhead/vue/dist/shared/vue.b1b42453.mjs
