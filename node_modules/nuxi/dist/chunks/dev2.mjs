...
import { s as setupDotenv } from '../shared/nuxi.4d3cc7b3.mjs';
import { d as defineCommand } from '../shared/nuxi.52a281c4.mjs';
import { S, c } from '../shared/nuxi.5362f0d4.mjs';
import './index2.mjs';
import 'node:http';
import 'node:https';
import 'node:util';
...
import { l as loadKit } from '../shared/nuxi.e48cc33c.mjs';
...
import 'util';
import 'tty';
import '../shared/nuxi.b0759dfe.mjs';
import 'events';
import 'stream';
import 'node:url';
import 'http';
...
import 'node:assert';
import 'node:v8';
import '../shared/nuxi.a20206d5.mjs';
import 'node:stream';
...
const command = defineCommand({
  ...
  async run(ctx) {
    ...
    if (ctx.args.fork) {
      ...
      const { createNuxtDevServer } = await import('./dev.mjs');
...
function _resolveListenOptions(nuxtOptions, args) {
  ...
  const httpsEnabled = args.https == true || args.https === void 0 && !!_devServerConfig.https;
